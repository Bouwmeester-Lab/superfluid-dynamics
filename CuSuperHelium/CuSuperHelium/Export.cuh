...
extern "C" 
{
	...
	__declspec(dllexport) int calculateVorticities256FromVectors(const c_double* Z, const c_double* phi, double* a, double L, double rho, double kappa, double depth);
